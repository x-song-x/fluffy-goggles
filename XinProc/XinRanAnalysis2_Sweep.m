...
D.PtOne_MeanForEachPixel =	mean(T.PtFt_DataRaw, 2);
D.PtFt_NormSes =            T.PtFt_DataRaw./(D.PtOne_MeanForEachPixel*...
                                ones(1, D.N_Ft)) - 1;
...
T.ImgMag =	3.0;        D.N_PwImg = D.N_Pw*T.ImgMag;    D.N_PhVar = D.N_Ph*T.ImgMag; 
...
for j = 1:4
    ...
    T.hFig2AxesVar(j) = axes(...
                'Parent',       T.hFig(2),...
                'Units',        'pixels',...  
                'Position',     [   T.S_FS(1)+  (T.S_BA(1)*2 + D.N_Pw*T.VarMag)*(T.AxesNumH-1), ...
                                    T.S_FS(2), ...
    ...
    T.hFig2VarColorbar(j) = colorbar(...
                'Units',        'pixels',...
                'Position',     [   T.S_FS(1)	+ (T.S_BA(1)*2 + D.N_Pw*T.VarMag)*(T.AxesNumH-1) + D.N_Pw*T.VarMag + 10, ...
                                    T.S_FS(2), ...
                                    10                  D.N_Ph*T.VarMag]);                     
    if strcmp(D.Fig2Var{j}.Title(1:3), 'STD')
...
T.hFig2AxesSpec = axes(...
            'Parent',       T.hFig(2),...
            'Units',        'pixels',...                      
            'Position',     [   T.S_FS(1) + T.S_CB*(0  )+D.N_Pw*(0  )*T.ImgMag , ...
                                T.S_FS(2)*(2  )+D.N_Ph*(0  )*T.ImgMag+D.N_Ph*(1)*T.VarMag, ...
                                D.N_Pw*T.ImgMag	D.N_Ph*T.ImgMag],...
            'NextPlot',     'add');
...
%% Axes: 1:2 Cycle Tuning Map
T.hFig2AxesTune = axes(...
            'Parent',       T.hFig(2),...
            'Units',        'pixels',...  
            'Position',     [   T.S_FS(1)*(1  )+D.N_Pw*(1  )*T.ImgMag ...
                                T.S_FS(2)*(2  )+D.N_Ph*(0  )*T.ImgMag+D.N_Ph*(1)*T.VarMag, ...
                                D.N_Pw*T.ImgMag    D.N_Ph*T.ImgMag],...
            'NextPlot',     'add',...
            'LabelFontSizeMultiplier', 1);   
...
T.hFig2SpecScalebarHue = colorbar(...
            ...
            'Units',        'pixels',...
            'Position',     [   T.S_FS(1)*(2  )+D.N_Pw*(2  )*T.ImgMag+10, ...
                                T.S_FS(2)*(2  )+D.N_Ph*(0  )*T.ImgMag+D.N_Ph*(1)*T.VarMag, ...
                                10                  D.N_Ph*T.ImgMag],...
            'Ticks',        [],...
            'Tag',          'TuneScalebarHue',...
...
T.hFig2SpecScalebarSat = colorbar(...
            ...
            'Units',        'pixels',...
            'Position',     [   T.S_FS(1)*(3  )+D.N_Pw*(2  )*T.ImgMag+40, ...
                                T.S_FS(2)*(2  )+D.N_Ph*(0  )*T.ImgMag+D.N_Ph*(1)*T.VarMag, ...
                                10                  D.N_Ph*T.ImgMag],...
            'Ticks',        [],...
            'Tag',          'TuneScalebarSat',...
...
T.hFig2SpecScalebarVal = colorbar(...
            ...
            'Units',        'pixels',...
            'Position',     [   T.S_FS(1)*(3  )+D.N_Pw*(2  )*T.ImgMag+70, ...
                                T.S_FS(2)*(2  )+D.N_Ph*(0  )*T.ImgMag+D.N_Ph*(1)*T.VarMag, ...
                                10                  D.N_Ph*T.ImgMag],...
            'Ticks',        [],...
            'Tag',          'TuneScalebarVal',...
...
T.hFig2AxesTemp = axes(...
            'Parent',       T.hFig(2),...
            'Units',        'pixels',...  
            'Position',     [   T.S_FS(1)*(6  )+D.N_Pw*(2  )*T.ImgMag, ...
                                T.S_FS(2)*(2  )+D.N_Ph*(0  )*T.ImgMag+D.N_Ph*(1)*T.VarMag, ...
                                D.N_Pw*T.ImgMag,	D.N_Ph*T.ImgMag]);  
...
T.hFig2AxesFrme = axes(...
            'Parent',       T.hFig(2),...
            'Units',        'pixels',...  
            'Position',     [   T.S_FS(1)*(3  )+D.N_Pw*(1  )*T.ImgMag, ...
                                T.S_FS(2)*(3  )+D.N_Ph*(1  )*T.ImgMag+D.N_Ph*(1)*T.VarMag, ...
                                D.N_Pw*T.ImgMag,	D.N_Ph*T.ImgMag],...
            'LabelFontSizeMultiplier', 1);  
...
T.hFig2AxesFrmeScalebar = colorbar(...
            ...
            'Units',        'pixels',...
            'Position',     [   T.S_FS(1)*(3  )+D.N_Pw*(2  )*T.ImgMag+10, ...
                                T.S_FS(2)*(3  )+D.N_Ph*(1  )*T.ImgMag+D.N_Ph*(1)*T.VarMag, ...
                                10,                     D.N_Ph*T.ImgMag],...   
            'Limits',       T.max*[-1 1],...
            'Tag',          'FrmeScalebar',...
