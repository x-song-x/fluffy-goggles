...
D.FptTtPt_NormTrlM =	reshape(D.FptPhPw_NormTrlM,...
                                    ...
                                    D.N_Tt, ...
                                    D.N_Pt);  
T.TempMax =             max(max(max(abs(D.FptTtPt_NormTrlM(:,:,:))))); 
T.PsuedoDelay =         2.6;
switch A.FileName{1}([15:17 end-15:end-7])
    case 'NIR_Ring_PBS';    T.Polarity =    -1; 
    case 'NIR_Pola_PBS';    T.Polarity =    -1; 
    case 'Far_Pola_PBS';    T.Polarity =     1; 
    case 'FRe_Pola_PBS';    T.Polarity =     1; 
    case 'Red_Pola_PBS';    T.Polarity =     1; 
    case 'Yel_Pola_PBS';    T.Polarity =     1; 
    case 'Amb_Pola_PBS';    T.Polarity =     1; 
    case 'Gre_Pola_PBS';    T.Polarity =    -1; 
    case 'Blu_Pola_PBS';    T.Polarity =    -1;
    case 'Blu_Fluo_GFP';    T.Polarity =     1;     T.PsuedoDelay = 0.8-0.8;
    otherwise;              T.Polarity =     1;
end
...
T.hFig2AxesHistHistogramAll = histogram(squeeze(D.PtQt_FFTAgl(:,21)),32,...
            'Parent',       T.hFig2AxesHist);
T.hFig2AxesHistHistogramIn = histogram(squeeze(D.PtQt_FFTAgl(D.PtIndex_ROIin,21)),32,...
            'Parent',       T.hFig2AxesHist);
set(T.hFig2AxesHist,...
            'XLim',         [0 2*pi],...
            'XTick',        (0:0.25:2)*pi,...
