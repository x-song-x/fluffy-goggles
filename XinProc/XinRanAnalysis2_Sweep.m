 % Xintrinsic continuous cycle Based Session 
clear all
...
% Figure
if S.TrlNumTotal>8;	T.VarMag = 	1.6;
else;               T.VarMag =	2;
end
                    T.SpecMag =	3;
...
T.AxesSCB =                 60;         % Axes, Space of ColorBar
...
%     D.FptTtCtPhPw_NormTrl =	D.FptTtCtPhPw_NormSes;
...
for j = 1:5
    ...
    T.hFig2AxesVar(j) = axes(...
                'Parent',       T.hFig(2),...
                'Units',        'pixels',...  
                'Position',     [   T.AxesSide(1) + (T.AxesSCB + D.N_Pw*T.VarMag)*(T.AxesNumH-1), ...
    ...
    T.hFig2VarColorbar(j) = colorbar(...
                'Units',        'pixels',...
                'Position',     [   T.AxesSide(1) + (T.AxesSCB + D.N_Pw*T.VarMag)*(T.AxesNumH-1) + D.N_Pw*T.VarMag + 10, ...
                                    T.AxesSide(2) +  T.AxesSB,...
                                    10                      D.N_Ph*T.VarMag]);                     
    if strcmp(D.Fig2Var{j}.Title(1:3), 'STD')
...
T.hFig2AxesSpec = axes(...
            'Parent',       T.hFig(2),...
            'Units',        'pixels',...                      
            'Position',     [   T.AxesSide(1)*(2  )+D.N_Pw*(0  )*T.SpecMag, ...
                                T.AxesSide(2)*(2  )+D.N_Ph*(0  )*T.SpecMag+D.N_Ph*(1)*T.VarMag, ...
...
%% Axes: Phase Histogram
T.hFig2AxesHist = axes(...
            'Parent',       T.hFig(2),...
            'Units',        'pixels',...                      
            'Position',     [   T.AxesSide(1)*(2  )+D.N_Pw*(0  )*T.SpecMag, ...
                                T.AxesSide(2)*(3  )+D.N_Ph*(1  )*T.SpecMag+D.N_Ph*(1)*T.VarMag, ...
                                D.N_Pw*T.SpecMag	D.N_Ph*T.SpecMag],...
            'NextPlot',     'add',...
            'LabelFontSizeMultiplier', 1); 
...
T.hFig2AxesTune = axes(...
            'Parent',       T.hFig(2),...
            'Units',        'pixels',...  
            'Position',     [   T.AxesSide(1)*(3  )+D.N_Pw*(1  )*T.SpecMag ...
                                T.AxesSide(2)*(2  )+D.N_Ph*(0  )*T.SpecMag+D.N_Ph*(1)*T.VarMag, ...
                                D.N_Pw*T.SpecMag    D.N_Ph*T.SpecMag],...
            'NextPlot',     'add',...
            'LabelFontSizeMultiplier', 1);   
...
T.hFig2SpecScalebarHue = colorbar(...
            ...
            'Units',        'pixels',...
            'Position',     [   T.AxesSide(1)*(3  )+D.N_Pw*(2  )*T.SpecMag+10, ...
                                T.AxesSide(2)*(2  )+D.N_Ph*(0  )*T.SpecMag+D.N_Ph*(1)*T.VarMag, ...
                                10                  D.N_Ph*T.SpecMag],...
            'Ticks',        [],...
            'Tag',          'TuneScalebarHue',...
...
T.hFig2SpecScalebarSat = colorbar(...
            ...
            'Units',        'pixels',...
            'Position',     [   T.AxesSide(1)*(3  )+D.N_Pw*(2  )*T.SpecMag+40, ...
                                T.AxesSide(2)*(2  )+D.N_Ph*(0  )*T.SpecMag+D.N_Ph*(1)*T.VarMag, ...
                                10                  D.N_Ph*T.SpecMag],...
            'Ticks',        [],...
            'Tag',          'TuneScalebarSat',...
...
T.hFig2SpecScalebarVal = colorbar(...
            ...
            'Units',        'pixels',...
            'Position',     [   T.AxesSide(1)*(3  )+D.N_Pw*(2  )*T.SpecMag+70, ...
                                T.AxesSide(2)*(2  )+D.N_Ph*(0  )*T.SpecMag+D.N_Ph*(1)*T.VarMag, ...
                                10                  D.N_Ph*T.SpecMag],...
            'Ticks',        [],...
            'Tag',          'TuneScalebarVal',...
...
T.hFig2AxesTemp = axes(...
            'Parent',       T.hFig(2),...
            'Units',        'pixels',...  
            'Position',     [   T.AxesSide(1)*(6  )+D.N_Pw*(2  )*T.SpecMag, ...
                                T.AxesSide(2)*(2  )+D.N_Ph*(0  )*T.SpecMag+D.N_Ph*(1)*T.VarMag, ...
                                D.N_Pw*T.SpecMag,	D.N_Ph*T.SpecMag]);  
...
T.hFig2AxesPixl = axes(...
            ...
            'Position',     [   T.AxesSide(1)*(6  )+D.N_Pw*(2  )*T.SpecMag, ...
                                ...
                                D.N_Pw*T.SpecMag,	D.N_Ph*T.SpecMag]);  
plot(   (1:D.N_Fpt)/P.ProcFrameRate,...
        squeeze( D.FptTtPt_NormTrlM(:,k,D.PtIndex_ROIin) )   );
set(gca,    'XLim',         [0 D.N_Fpt/P.ProcFrameRate]);    
if      D.N_Ftpreoff >0 && D.N_Ftposton<D.N_Fpt
    set(gca,'XTick',        [0 D.N_Ftpreoff D.N_Ftstimoff D.N_Fpt]/P.ProcFrameRate); 
elseif	D.N_Ftpreoff >0 
...
ylabel({'Norm. signal, raw polarity'},...
            'Parent',       gca,...
            'VerticalAlignment',    'Middle');
title('Pixel: temporal traces across reps');
set(gca,    'XGrid',        'on',... 
            'LabelFontSizeMultiplier', 1);
...
setappdata(T.hFig2AxesSpec,         'SpecAmp',          D.PtQt_FFTAmp);
setappdata(T.hFig2AxesSpec,         'SpecAgl',          D.PtQt_FFTAgl);
...
setappdata(T.hFig2AxesTuneImage,    'RawHue',           D.PtOne_Hue);
setappdata(T.hFig2AxesTuneImage,    'RawSat',           D.PtOne_Saturation);
setappdata(T.hFig2AxesTuneImage,    'RawVal',           D.PtOne_Value);
...
setappdata(T.hFig2AxesFrmeImage,    'FptPhPw_NormTrlVid', D.FptPhPw_NormTrlVid);
