...
R.Fig2Var{5}.ColorMap =     'parula'; 
    ...
    for j = 1:5
        ...
        T.hFig2AxesVar(j) = axes(...
                    'Parent',       T.hFig(2),...
                    'Units',        'pixels',...  
                    'Position',     [   T.AxesSide(1) + (T.AxesSCB + R.N_Pw*T.VarMag)*(T.AxesNumH-1), ...
                                        T.AxesSide(2) +  T.AxesSB,...
                                        R.N_Pw*T.VarMag,    R.N_Ph*T.VarMag],...
                    'Tag',          [num2str(j), 'Var']);
        ...
        T.hFig2VarColorbar(j) = colorbar(...
                    'Units',        'pixels',...
                    'Position',     [   T.AxesSide(1) + (T.AxesSCB + R.N_Pw*T.VarMag)*(T.AxesNumH-1) + R.N_Pw*T.VarMag + 10, ...
                                        T.AxesSide(2) +  T.AxesSB,...
                                        10                      R.N_Ph*T.VarMag]);                     
        if strcmp(R.Fig2Var{j}.Title(1:3), 'STD')
...
R.PtIndex_STD =        squeeze(std(R.FptTtPt_NormTrlM(:,1,R.PtIndex_ROIin), 1));

%% Spectral Analysis  

R.PtQt_FFTRaw =        fft(T.Polarity * R.PtFt_NormSes')';          % in proportion
R.PhPwQt_FFTRaw =      reshape(R.PtQt_FFTRaw,...
                            R.N_Ph, R.N_Pw, length(R.Qt_Freqs));
R.PtQt_FFTAbs =        abs(R.PtQt_FFTRaw)*2/length(R.Qt_Freqs);     % in 2*rms
...
end                         % Reverse the hue for DOWN cycle               
% S.TrlDurPreStim =   2.5;
% S.TrlDurStim =      15;
...
% Necessary Record
    ...
    T.hFig2AxesSpec(1) = axes(...
                ...
                'Position',     [   T.AxesSide(1)*(1  )+R.N_Pw*(0  )*T.SpecMag, ...
                                    T.AxesSide(2)*(2  )+R.N_Ph*(0  )*T.SpecMag+R.N_Ph*(1)*T.VarMag, ...
...
%                 'Location',     'Northeast');
	...
	setappdata(T.hFig2AxesTuneImage,    'ValLimRange',      0.025/100*2.^(0:0.5:6));
    ...
    XinRanAnalysis2_Sweep_ScaleBar(T.hFig2SpecScaleBarSat);       
...
m = T.TrialOrder(k);
        ...
        T.hFig2AxesTemp(m) = axes(...
                    'Parent',       T.hFig(2),...
                    'Units',        'pixels',...  
                    'Position',     [   T.AxesSide(1)*(5  )+R.N_Pw*(2  )*T.SpecMag, ...
                                        T.AxesSide(2)*(2  )+R.N_Ph*(0  )*T.SpecMag+R.N_Ph*(1)*T.VarMag, ...
                                        R.N_Pw*T.SpecMag,	R.N_Ph*T.SpecMag]);
        ...
        T.hFig2AxesVid(m) = axes(...
                    ...
                    'Units',        'pixels',...  
                    'Position',     [   T.AxesSide(1)*(2  )+R.N_Pw*(1  )*T.SpecMag, ...
                                        T.AxesSide(2)*(3  )+R.N_Ph*(1  )*T.SpecMag+R.N_Ph*(1)*T.VarMag, ...
                                        R.N_Pw*T.SpecMag,	R.N_Ph*T.SpecMag]);
