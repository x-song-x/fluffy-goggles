...
switch A.FileName{1}([15:17 end-15:end-7])
    case 'NIR_Ring_PBS';    T.Polarity =    -1;     T.PsuedoDelay =	2.6;
    case 'NIR_Pola_PBS';    T.Polarity =    -1;     T.PsuedoDelay =	2.6;
    case 'Far_Pola_PBS';    T.Polarity =     1;     T.PsuedoDelay =	2.6;
    case 'FRe_Pola_PBS';    T.Polarity =     1;     T.PsuedoDelay =	2.6;
    case 'Red_Pola_PBS';    T.Polarity =     1;     T.PsuedoDelay =	2.6;
    case 'Yel_Pola_PBS';    T.Polarity =     1;     T.PsuedoDelay =	2.6;
    case 'Amb_Pola_PBS';    T.Polarity =     1;     T.PsuedoDelay =	2.6;
    case 'Gre_Pola_PBS';    T.Polarity =    -1;     T.PsuedoDelay =	2.6;
    case 'Blu_Pola_PBS';    T.Polarity =    -1;     T.PsuedoDelay =	2.6;
...
set(T.hFig2AxesTune, ...
            ...
            'XTick',        [],...
            'YTick',        []);
xlabel('Hue: compensated phase angle; Value: phase amplitude');
...
T.hFig2AxesTemp = axes(...
            ...
            'Position',     [   T.S_FS(1)+T.S_BA(1)*(4  )+D.N_PwImg*(2  ), ...
                                T.S_FS(2)+T.S_BA(2)*(1  )+D.N_PhImg*(0  )+D.N_PhVar*(1  ), ...
                                D.N_PwImg,	D.N_PhImg]);  
plot(   (1:D.N_Fpt)/P.ProcFrameRate, D.FptPt_NormTrl(:,D.PtIndex_ROIin)   );
...
T.hFig2AxesTempHid = axes(...
            ...
            'YTick',        [],...
            'NextPlot',     'add');
T.hFig2AxesTempTextNum =    text(   D.N_Fpt*0.04,	0.97, sprintf('@%4.1fs',0),...
...
%% Axes: 2:2, Frme: Frame @ each time point        
...
T.hFig2AxesPixlLineAll = plot(   (1:D.N_Fpt)/P.ProcFrameRate,...
        squeeze( D.FptCtPhPw_NormTrl(:,:,37,60) ),...
...
T.hFig2AxesPixlLineMean = plot(   (1:D.N_Fpt)/P.ProcFrameRate,...
        mean(squeeze( D.FptCtPhPw_NormTrl(:,:,37,60) ),2),...
            'Parent',       T.hFig2AxesPixl,...
            'LineWidth',    2,...
            'Color',        [0 0 0]);
set(gca,    'XLim',         [0 D.N_Fpt/P.ProcFrameRate]);    
