...
R.PhPwThree_TuneMap =  reshape(R.PtThree_TuneMap, R.N_Ph, R.N_Pw,3);
    ...
    T.hFig2AxesSpec(2) = axes(...
                ...
                'Position',     [   T.AxesSide(1)*(2  )+R.N_Pw*(1  )*T.SpecMag ...
                                    ...
                                    R.N_Pw*T.SpecMag    R.N_Ph*T.SpecMag],...
                'NextPlot',     'add');   
    T.hFig2AxesSpecImage = image(T.hFig2AxesSpec(2), R.PhPwThree_TuneMap);
    set(T.hFig2AxesSpec(2), ...
                'YDir',         'reverse',...
                'XLim',         [1 R.N_Pw],...
                'YLim',         [1 R.N_Ph],...
                'XTick',        [],...
    ...
    T.hFig2AxesSpec(3) = axes(...
                ...
                'Position',     [   T.AxesSide(1)*(2  )+R.N_Pw*(1  )*T.SpecMag ...
                                    ...
                                    R.N_Pw*0    R.N_Ph*0],...
                'Visible',     'off'); 
    colormap(   T.hFig2AxesSpec(3), 'gray');
    caxis( [0   0.005]);
    T.hFig2SpecColorbar(1) = colorbar(...
                'Units',        'pixels',...
                'Position',     [   T.AxesSide(1)*(2  )+R.N_Pw*(2  )*T.SpecMag+10, ...
                                    T.AxesSide(2)*(3  )+R.N_Ph*(2  )*T.ImageMag, ...
                                    10                  R.N_Ph*T.SpecMag]);  
    set(T.hFig2SpecColorbar(1),...
                'ButtonDownFcn','XinRanAnalysis2_Sweep_ValBar');
	setappdata(T.hFig2SpecColorbar(1), ...
                'RawHue',       R.PtOne_Hue);
	setappdata(T.hFig2SpecColorbar(1), ...
                'RawSat',       R.PtOne_Saturation);
	setappdata(T.hFig2SpecColorbar(1), ...
                'RawVal',       R.PtOne_Value);
	setappdata(T.hFig2SpecColorbar(1), ...
                'ValLim',       0.005);
	setappdata(T.hFig2SpecColorbar(1), ...
    ...
    T.hFig2AxesSpec(4) = axes(...
                ...
                'Position',     [   T.AxesSide(1)*(2  )+R.N_Pw*(1  )*T.SpecMag ...
                                    ...
                                    R.N_Pw*0    R.N_Ph*0],...
                'Visible',     'off'); 
    colormap(   T.hFig2AxesSpec(4), 'hsv');
    caxis( [0 R.HueLim]);
    T.hFig2SpecColorbar(2) = colorbar(...
                'Units',        'pixels',...
                'Position',     [   T.AxesSide(1)*(2  )+R.N_Pw*(2  )*T.SpecMag+70, ...
                                    T.AxesSide(2)*(3  )+R.N_Ph*(2  )*T.ImageMag, ...
                                    10                  R.N_Ph*T.SpecMag]);  
    set(T.hFig2SpecColorbar(2),...
                'Ticks',        [0 R.HueLim],...
                'TickLabels',   {'Onset', 'Offset'});
...
%% Variance Analysis (This part is old, but saved @20190430)
% R.PtOne_MeanForEachPixel =	mean(R.PtFt_A0, 2);
% R.PtFt_NormSes =           R.PtFt_A0./(R.PtOne_MeanForEachPixel*...
%                                 ones(1, R.N_Ft)) - 1;
% R.FptTtCtPhPw_NormSes =	permute( reshape(R.PtFt_NormSes, ...
...
%                                     R.N_Pt);  
% 
% R.Fig2Var{1}.Title =       'Average intensity (ADU)';
% R.Fig2Var{1}.PhPw_Data =   reshape(R.PtOne_MeanForEachPixel, R.N_Ph, R.N_Pw);
% R.Fig2Var{1}.ColorMap =    'parula';    
% 
% R.Fig2Var{2}.Title =       'STD, entire session (ratio)';
% R.Fig2Var{2}.PhPw_Data =   reshape( std(R.PtFt_NormSes,0,2), R.N_Ph, R.N_Pw );
% R.Fig2Var{2}.ColorMap =    'jet';
% 
% %     R.Fig2Var{3}.PhPw_Data =   squeeze(mean(mean(std(R.FptTtCtPhPw_NormTrl, 0, 3), 1), 2));
% %     R.Fig2Var{4}.PhPw_Data =   squeeze(mean(mean(std(R.FptTtCtPhPw_NormTrl, 0, 2), 1), 3));
% %     R.Fig2Var{5}.PhPw_Data =   squeeze(mean(mean(std(R.FptTtCtPhPw_NormTrl, 0, 1), 2), 3));   
% 
% R.Fig2Var{3}.Title =       'STD, across repetition cycles (ratio)';
% R.Fig2Var{3}.PhPw_Data =   squeeze(std(mean(mean(R.FptTtCtPhPw_NormTrl, 1), 2), 0, 3));
% R.Fig2Var{3}.ColorMap =    'jet';    
% 
% R.Fig2Var{4}.Title =       'STD, across different trials (ratio)';
% R.Fig2Var{4}.PhPw_Data =   squeeze(std(mean(mean(R.FptTtCtPhPw_NormTrl, 1), 3), 0, 2));
% R.Fig2Var{4}.ColorMap =    'jet';    
% 
% R.Fig2Var{5}.Title =       'STD, across frames within each trial (ratio)';
% R.Fig2Var{5}.PhPw_Data =   squeeze(std(mean(mean(R.FptTtCtPhPw_NormTrl, 2), 3), 0, 1));
% R.Fig2Var{5}.ColorMap =    'jet'; 
%     delete(T.hFig(1));
%     T.hFig(2) = figure(...
%                     'Name',         ['"', F.FileName{1}, '" with the sound: "', S.SesSoundFile, '"'],...
%                     'Units',        'pixels',...  
...
%                     'Parent',       T.hFig(2),...
%                     'Units',        'pixels',...  
%                     'Position',     [   T.AxesSide*j+R.N_Pw*(j-1)*T.ImageMag,...
%                                         T.AxesSide,...
%                                         R.N_Pw*T.ImageMag    R.N_Ph*T.ImageMag]);
%         if strcmp(R.Fig2Var{j}.Title(1:3), 'STD')
%             imagesc(    log10(      R.Fig2Var{j}.PhPw_Data)    );
...
%         T.hFig2VarColorbar(j) = colorbar(...
%                     'Units',        'pixels',...
%                     'Position',     [   T.AxesSide*j+R.N_Pw*j*T.ImageMag+10,...
%                                         T.AxesSide,...
%                                         10                      R.N_Ph*T.ImageMag]);                     
%         if strcmp(R.Fig2Var{j}.Title(1:3), 'STD')
%             set(T.hFig2VarColorbar(j),...
...
%         end
%         title(R.Fig2Var{j}.Title);
%         xlabel( {[  'max:',         num2str(max(max(R.Fig2Var{j}.PhPw_Data)))],...
%                  [  'min:',         num2str(min(min(R.Fig2Var{j}.PhPw_Data)))]} );
%     end