...
for i = 1:length(A.Fig2Var)
    ...
    if T.version    
        T.H.hFig2AxesVar(i).Toolbar.Visible = 'off';   
    end
end 
...
T.H.hFig2AxesTempDot = plot(1, 1, 'o',...
            ...
            'Color',        [1 0 0]);
	if T.version    
        T.H.hFig2AxesTemp.Toolbar.Visible =     'off';   
        T.H.hFig2AxesTempHid.Toolbar.Visible =  'off';   
	end
...
T.H.hFig2AxesPixlText = text(   A.N_Fpt*0.04,	0.97, {...
	...
	if T.version    
        T.H.hFig2AxesPixl.Toolbar.Visible =     'off';   
        T.H.hFig2AxesPixlHid.Toolbar.Visible =  'off';   
	end
...
T.H.hFig2AxesSpecTextLeft =   text(   0.05,   0.9, '<',...
            ...
            'ButtonDownFcn','XinRanAnalysis2_Sweep_ButtonDown');
	if T.version    
        T.H.hFig2AxesSpec.Toolbar.Visible =     'off';   
        T.H.hFig2AxesSpecHid.Toolbar.Visible =  'off';   
	end
...
set(gca,    'LabelFontSizeMultiplier', 1);
	if T.version    
        T.H.hFig2AxesFrme.Toolbar.Visible =     'off';    
	end
...
T.H.hFig2SpecScalebarVal = colorbar(...
            ...
            'ButtonDownFcn','XinRanAnalysis2_Sweep_ButtonDown');
	if T.version    
        T.H.hFig2AxesTune.Toolbar.Visible =         'off';   
        T.H.hFig2AxesTuneHidHue.Toolbar.Visible =	'off';  
        T.H.hFig2AxesTuneHidSat.Toolbar.Visible =	'off'; 
        T.H.hFig2AxesTuneHidVal.Toolbar.Visible =	'off';  
	end
...
legend(     {'All pixels', 'In ROI'},...
            ...
            'Box',          'off');
	if T.version    
        T.H.hFig2AxesHist.Toolbar.Visible =         'off';   
	end
