...
sys.Vis.CycleNumTotal =         stm.SesDurTotal/stm.Vis.CycleDurTotal;     % rep # total
sys.Vis.CycleNumCurrent =       0;
...
sys.NIDAQ.TaskCO.cfgImplicitTiming(...
    'DAQmx_Val_FiniteSamps',	sys.Vis.CycleNumTotal+1);
...
while stm.Vis.Running
    ...
    % Session timing
    stm.Vis.SesOn =           (   sys.Vis.CycleNumCurrent>0 && ...
                                    sys.Vis.CycleNumCurrent<=sys.Vis.CycleNumTotal);
    stm.Vis.CycleDurTotalCurrent =    toc(sys.Vis.CycleDurCurrentTimer); 
